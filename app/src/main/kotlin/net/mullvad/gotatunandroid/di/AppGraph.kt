...
interface AppGraph {
  ...
  @Provides fun provideVpnController(context: Context): VpnController = VpnControllerImpl(context)

  @Provides fun provideNavigationViewModel(): NavigationViewModel = NavigationViewModel()
